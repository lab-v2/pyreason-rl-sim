...
DATA_PATH = f"./non_markov_shoot_{NUM_AGENTS_TEAM}/"
...
for y in dir_files:
    if y.endswith(".pth") and y.startswith("dqn_Shoot-Multi-NonM-Soldier-st_13_Aug_11AM_"):
        eval_step = y.split("_")[-1].split(".")[0][1:]
        eval_step = int(eval_step)
        if eval_step % 32000 == 0:
            ...
            soldier_net.eval()
            t = f'dqn_Shoot-Multi-NonM-Soldier-st_13_Aug_11AM_s{eval_step}.pth'
...
with open(f'non_markov_shoot_eval_{NUM_AGENTS_TEAM}.json', 'w') as fp:
